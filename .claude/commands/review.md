---
description: Sniff bad smells in Review-phase artifacts (source code, architecture, documentation set, agent skill definitions). Returns one unified graybox report.
argument-hint: <artifact-path>...
---

Targets: $ARGUMENTS

Sniff the supplied target(s) as Review-phase artifacts. Engage the **Review-phase** sniffer skills whose audit domain matches what was supplied; when more than one applies to the same target or to sibling targets in scope, run all that fit.
