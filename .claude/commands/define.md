---
description: Sniff bad smells in Define-phase artifacts (requirements, design, RFC, ADR). Returns one unified graybox report.
argument-hint: <artifact-path>...
---

Targets: $ARGUMENTS

Sniff the supplied target(s) as Define-phase artifacts. Engage the **Define-phase** sniffer skills whose audit domain matches what was supplied; when more than one applies to the same target or to sibling targets in scope, run all that fit.
