---
description: Sniff bad smells in Ship-phase artifacts (commit history, pull requests, CI/CD pipelines, migration plans, release checklists). Returns one unified graybox report.
argument-hint: <artifact-path>...
---

Targets: $ARGUMENTS

Sniff the supplied target(s) as Ship-phase artifacts. Engage the **Ship-phase** sniffer skills whose audit domain matches what was supplied; when more than one applies to the same target or to sibling targets in scope, run all that fit.
