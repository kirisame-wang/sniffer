---
description: Sniff bad smells in Build-phase artifacts (API contracts, schemas, type definitions, UI specs and mockups). Returns one unified graybox report.
argument-hint: <artifact-path>...
---

Targets: $ARGUMENTS

Sniff the supplied target(s) as Build-phase artifacts. Engage the **Build-phase** sniffer skills whose audit domain matches what was supplied; when more than one applies to the same target or to sibling targets in scope, run all that fit.
