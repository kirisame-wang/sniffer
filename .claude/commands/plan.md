---
description: Sniff bad smells in Plan-phase artifacts (task lists, implementation plans, work breakdowns). Returns one unified graybox report.
argument-hint: <artifact-path>...
---

Targets: $ARGUMENTS

Sniff the supplied target(s) as Plan-phase artifacts. Engage the **Plan-phase** sniffer skills whose audit domain matches what was supplied; when more than one applies to the same target or to sibling targets in scope, run all that fit.
